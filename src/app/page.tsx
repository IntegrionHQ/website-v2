...
export default function Home() {
  ...
  return (
   <main className=" mx-10 md:mx-20 border-l border-r  border-l-gray-400 border-r-gray-500 space-y-20">
    <div className="border-b border-t-gray-500 border-b-gray-500">
 <div className="flex flex-col items-start justify-center h-screen gap-2  p-5 md:p-10">
     ...
     <h1 className="text-white text-6xl tracking-wide md:w-3/4">
      The AI-powered way to test backend and infra natively
     </h1>
     <p className="text-gray-300 text-lg md:w-1/2 font-graphik">Infra-native AI agents hunt bugs, test reliability, and optimize performance — so engineers ship safely and fast</p>
   ...
   <div className="border-b border-t border-t-gray-500 border-b-gray-500">
      <div className="flex flex-col justify-center items-center gap-2 p-10">
         <div className="relative mt-20 md:w-5/6 mx-auto">
      <HeroVideoDialog
   ...
   <div className="border-b border-t border-t-gray-500 border-b-gray-500">
      <div className="flex flex-col justify-center items-center gap-2 p-10">
        <h2 className="text-4xl text-white font-normal md:w-3/4 text-center">Your AI safety net for backend and infrastructure code</h2>
   ...
   <div className="border-b border-t border-t-gray-500 border-b-gray-500">
    <div className=" w-full flex md:flex-row flex-col justify-between items-center gap-2 p-10">
      <div className="md:w-1/2 flex flex-col justify-center items-start gap-2">
<h2 className="text-4xl text-white font-normal  ">We're partnering with forward-thinking engineering teams</h2>
      ...
      <div className="w-1/2">
<Image src="/swoosh.png" alt="Partner Illustration" width={200} height={200} className="w-full" />
      </div>
    </div>
   </div>
   </main>
